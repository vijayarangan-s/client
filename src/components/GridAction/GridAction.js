...
import CustomResultProcessing from "./CustomResultProcessing";
...
class GridAction extends Component {
    constructor(props){
        ...
        this.customAutoComplete = new CustomAutoComplete(this.products,this.options);
    }
...
onParseOk(expressions) {
    ...
    var newData = new CustomResultProcessing(this.options).process(this.state.products, expressions);
    console.log({newData})
